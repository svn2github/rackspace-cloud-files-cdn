...
abstract class Service extends Base
{
    ...
    */
    ...
    public function Collection($class, $url = null, $parent = null, array $parm = array())
    {
        ...
        // Parse the return
        $the_response = $response->HttpBody();
        $obj = json_decode($the_response, true);
        ...
        // if there's a $next_page_url, then we need to establish a callback method
